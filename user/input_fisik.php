						...
						<li>
							...
							<div id="subFisik" class="collapse in">
								<ul class="nav">
									...
									<li><a href="input_fisik.php" class="active">Input Data Fisik</a></li>
								</ul>
							</div>
						</li>
						<li>
				...
				<div class="container-fluid">
					...
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Input Berkas Fisik</h3>
							<div class="right">
						...
						<div class="panel-body">
							<form class="" action="controller/inputfisik.php" method="POST">
            			...
            			<label for="nama" class="col-sm-2 col-form-label">Nama</label>
                			...
                			<input autocomplete="off" type="text" class="form-control" id="nama" name="nama" placeholder="Nama" required>
								...
								<div class="form-group row">
            			<label for="no_hak" class="col-sm-2 col-form-label">Nomor Hak Milik</label>
            				<div class="col-sm-10">
                			<input autocomplete="off" type="text" class="form-control" id="no_hak" name="no_hak" placeholder="Nomor Hak Milik" required>
            				</div>
        				</div>
								<div class="form-group row">
