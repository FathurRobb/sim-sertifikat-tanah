						...
						<div class="panel-body">
							...
							<div class="form-group row">
								<label for="nama" class="col-sm-2 col-form-label">Nama</label>
									<div class="col-sm-10">
										<input autocomplete="off" type="text" class="form-control" id="nama" name="nama" placeholder="Nama" value="<?php echo $data['nama']; ?>" required>
									</div>
							</div>
        				<div class="form-group row">
            			...
            			<label for="tahun" class="col-sm-2 col-form-label">Tahun</label>
            				<div class="col-sm-10">
                                <select class="form-control" name="tahun" required>
                                	...
                                	<option value="2019" <?php if($data['tahun']=="2023") echo 'selected="selected"'; ?>>2023</option>
                                	<option value="2019" <?php if($data['tahun']=="2024") echo 'selected="selected"'; ?>>2024</option>
                                	<option value="2019" <?php if($data['tahun']=="2025") echo 'selected="selected"'; ?>>2025</option>
                                </select>
            				</div>
        				</div>
								<div class="form-group row">
