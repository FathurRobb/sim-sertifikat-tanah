...
if(isset($_GET['submit'])){
	...
	$query = mysqli_query($connection, "SELECT * FROM data_fisik WHERE status='Selesai'");
	$judul = "Seluruh Berkas";
	$subjudul = "";
	$coba = "button disabled";
}
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="cetak.php" class="active"><i class="lnr lnr-printer"></i> <span>Cetak Nomor Pembagian</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
				...
				<div class="container-fluid">
					...
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Cari Berkas</h3>
							<div class="right">
					...
					<div class="panel">
						<div class="panel-heading">
							...
							<div class="panel-footer">
								<div class="row">
									<div class="text-right"><<?=$coba;?> href="download.php?desa=<?=$desa;?>&tahun=<?=$tahun;?>" target="_blank" class="btn btn-primary">Download</a></div>
								</div>
							</div>
						</div>
					</div>
