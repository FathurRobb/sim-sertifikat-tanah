...
if(isset($_GET['submit'])){
	$no_pbt = $_GET['no_pbt'];
	$desa = $_GET['desa'];
	$query = mysqli_query($connection, "SELECT * FROM data_pbt WHERE no_pbt LIKE '%".$no_pbt."%' AND desa LIKE '%".$desa."%'");
	$judul = "Hasil Pencarian";
	$subjudul = "Ditemukan 1 Data";
}else{
	$query = mysqli_query($connection, "SELECT * FROM data_pbt");

	$judul = "Seluruh Informasi Data PBT";
	$subjudul = "Total Data";
}
...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="index.php"><b>PENGUMPULAN DATA SERTIFIKAT </b><br> <center class=""><span class="logokecil"> KABUPATEN BANDUNG</span> </center></a>
			</div>
					...
					<ul class="nav">
						...
						<li>
							...
							<div id="subPBT" class="collapse in">
								<ul class="nav">
									<li><a href="data_pbt.php" class="active">Lihat Data PBT</a></li>
				...
				<div class="container-fluid">
					...
					<div class="panel">
						...
						<div class="panel-body">
							<form class="" action="data_pbt.php" method="GET">
								...
								<table class="table table-bordered">
									...
									<tbody>
										...
										<tr>
											...
											<td><?=$d['tahun'];?></td>
											<td><?=$d['dokumen'];?></td>
											<td><a href="download_pbt.php?filename=<?=$d['dokumen']?>">Download</td>
										</tr>
										<?php
									}
										?>
