...
(3, 'KP0004', 'KP0004_Berita Acara(1).doc', 'KP0004_Risalah 201B.doc', 'KP0004_SKTBMA.doc', 'KP0004_Surat Permohonan(1).doc', 'KP0004_Surat Pernyataan.doc', 'KP0004_Surat Riwayat Tanah.doc'),
(4, 'KP0005', 'KP0005_Berita Acara(1).doc', 'KP0005_Risalah 201B.doc', 'KP0005_SKTBMA.doc', 'KP0005_Surat Permohonan(1).doc', 'KP0005_Surat Pernyataan.doc', 'KP0005_Surat Riwayat Tanah.doc'),
...
INSERT INTO `permohonan` (`id_permohonan`, `id_user`, `kecamatan`, `desa`, `alamat`, `status`, `notif`) VALUES
('KP0001', 7, 'Andir', 'dungus cariang', 'Gang Mesjid Al-Hikmah', 'Disetujui', 'read'),
('KP0002', 9, 'Andir', 'Dungus Cariang', 'Rajawali TImur', 'Ditolak', 'read'),
('KP0004', 8, 'Pasir Subur', 'Suzuran', 'iccomits Konsultan IT', 'Disetujui', 'read'),
('KP0005', 8, 'nmbmbvmb aifyaf', 'hkjahfkjahliuaf', 'NBcjhaw uyfwuyfo yoqfy noayfo afy', 'Ditolak', 'read'),
('KP0006', 9, 'Cicendo', 'Pasir Kaliki', 'Jl. Kesatriaan No.1', 'Disetujui', 'read'),
('KP0007', 7, 'Baleendah', 'Bojong Soang', 'Jln. Melati No. 177', 'Belum Di Setujui', 'unread');
...
--
ALTER TABLE `pemohon_file`
  MODIFY `id_pemohon_file` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
