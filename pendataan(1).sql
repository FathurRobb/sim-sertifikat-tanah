...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 19, 2021 at 05:53 AM
...
(2, 'KP0002', 'KP0002_Berita Acara.doc', 'KP0002_Risalah 201B.doc', '', 'KP0002_Surat Permohonan.doc', 'KP0002_Surat Pernyataan.doc', 'KP0002_Surat Riwayat Tanah.doc');
...
('KP0002', 9, 'Andir', 'Dungus Cariang', 'Rajawali TImur', 'Proses');
...
--
ALTER TABLE `pemohon_file`
  MODIFY `id_pemohon_file` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
