...
$data = mysqli_query($connection,"SELECT * FROM data_fisik where no_berkas='$no_berkas'");
...
if (isset($_POST['update'])) {
	...
	$sql = $connection->prepare("UPDATE data_fisik SET desa=?, nama=?, no_hak=?, no_sertifikat=?, status=?, tahun=? WHERE no_berkas='$no_berkas'");
	$sql->bind_param("ssssss", $desa, $nama, $no_hak, $no_sertifikat, $status, $tahun);
	if ($sql->execute()) {
		echo '<script>alert("Data Berhasil Disimpan"); window.location = "fisik.php"</script>;';
	}else{
          ...
          <div class="w-full md:w-1/2 xl:w-1/2 p-3">
            <div class="bg-white border rounded shadow p-2">
              ...
              <form action="" method="post" class="bg-white rounded p-10">
                ...
                <input disabled id="no_berkas" autocomplete=off type="hidden" class="mt-1 inline-block bg-gray-200 focus:border-green-500 focus:border-6 shadow-sm appearance-none border rounded w-full py-2 px-3 text-sm text-gray-700 leading-normal focus:outline-none mb-4"  name="no_berkas" value="<?=$d['no_berkas'];?>"/>

								<label for="desa" class="flex flex-wrap text-sm font-bold text-gray-500 leading-tight">Desa</label>
                <input id="desa" autocomplete=off type="text" class="mt-1 inline-block bg-gray-200 focus:border-green-500 focus:border-6 shadow-sm appearance-none border rounded w-full py-2 px-3 text-sm text-gray-700 leading-normal focus:outline-none mb-4"  name="desa" value="<?=$d['desa'];?>"/>

                <label for="nama" class="flex flex-wrap text-sm font-bold text-gray-500 leading-tight">Nama Pemilik</label>
                <input id="nama" autocomplete=off type="text" class="mt-1 inline-block bg-gray-200 focus:border-green-500 focus:border-6 shadow-sm appearance-none border rounded w-full py-2 px-3 text-sm text-gray-700 leading-normal focus:outline-none mb-4"  name="nama" value="<?=$d['nama'];?>"/>

                <label for="no_hak" class="flex flex-wrap text-sm font-bold text-gray-500 leading-tight">Nomor Hak Milik</label>
                <input id="no_hak" autocomplete=off type="text" class="mt-1 inline-block bg-gray-200 focus:border-green-500 focus:border-6 shadow-sm appearance-none border rounded w-full py-2 px-3 text-sm text-gray-700 leading-normal focus:outline-none mb-4"  name="no_hak" value="<?=$d['no_hak'];?>"/>

                <label for="no_sertifikat" class="flex flex-wrap text-sm font-bold text-gray-500 leading-tight">Nomor Sertifikat</label>
                <input id="no_sertifikat" autocomplete=off type="text" class="mt-1 inline-block bg-gray-200 focus:border-green-500 focus:border-6 shadow-sm appearance-none border rounded w-full py-2 px-3 text-sm text-gray-700 leading-normal focus:outline-none mb-4"  name="no_sertifikat" value="<?=$d['no_sertifikat'];?>"/>
                ...
                <input id="tahun" autocomplete=off type="text" class="mt-1 inline-block bg-gray-200 focus:border-green-500 focus:border-6 shadow-sm appearance-none border rounded w-full py-2 px-3 text-sm text-gray-700 leading-normal focus:outline-none mb-4"  name="tahun" value="<?=$d['tahun'];?>"/>
