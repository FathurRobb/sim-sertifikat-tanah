...
$data = mysqli_query($connection,"SELECT * FROM data_sertifikat where no_sertifikat='$no_sertifikat'");
...
if (isset($_POST['update'])) {
	...
	$sql = $connection->prepare("UPDATE data_sertifikat SET desa=?, nama=?, status=?, tahun=? WHERE no_sertifikat='$no_sertifikat'");
	$sql->bind_param("ssss", $desa, $nama, $status, $tahun);
	if ($sql->execute()) {
		echo '<script>alert("Data Berhasil Disimpan"); window.location = "sertifikat.php"</script>;';
	}else{
      ...
      <div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white z-20" id="nav-content">
          <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
            ...
            <li class="mr-6 my-2 md:my-0">
              <a href="sertifikat.php" class="block py-1 md:py-3 pl-1 align-middle text-purple-500 no-underline hover:text-gray-900 border-b-2 border-purple-500 border-white hover:border-purple-500">
          ...
          <div class="w-full md:w-1/2 xl:w-1/2 p-3">
            <div class="bg-white border rounded shadow p-2">
              ...
              <form action="" method="post" class="bg-white rounded p-10">
                ...
                <input disabled id="no_sertifikat" autocomplete=off type="hidden" class="mt-1 inline-block bg-gray-200 focus:border-green-500 focus:border-6 shadow-sm appearance-none border rounded w-full py-2 px-3 text-sm text-gray-700 leading-normal focus:outline-none mb-4"  name="no_sertifikat" value="<?=$d['no_sertifikat'];?>"/>
