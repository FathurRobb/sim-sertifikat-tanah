...
$no_pbt = $_GET['no_pbt'];
$data = mysqli_query($connection, "SELECT * FROM data_pbt WHERE no_pbt='$no_pbt'");
...
if(isset($_POST['update'])){
  ...
  $sql = $connection->prepare("UPDATE data_pbt SET desa=?, tahun=?, nama=? WHERE no_pbt=?");
  $sql->bind_param("ssss", $desa, $tahun, $nama, $no_pbt);
  if($sql->execute()){
      ...
      <div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white z-20" id="nav-content">
          <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
            ...
            <li class="mr-6 my-2 md:my-0">
              <a href="#" class="block py-1 md:py-3 pl-1 align-middle text-green-500 no-underline hover:text-gray-900 border-b-2 border-white border-green-500 hover:border-green-500">
        ...
        <div class="inline flex flex-wrap items-center justify-center">
          <div class="w-full md:w-1/2 xl:w-1/2 p-3">
            <div class="bg-white border rounded shadow p-10">
                <li class="list-none"><span class="text-sm text-gray-500">Data PBT > Edit Data PBT</span></li>
                <li class="list-none"><span class="text-xl font-bold">Edit Data PBT</span></li>
                <?php
                while($d = mysqli_fetch_array($data)){
                ?>
              <form action="" method="POST" class="bg-white rounded mt-4">

                <label for="no_pbt" class="flex flex-wrap text-sm font-bold text-gray-500 leading-tight">Nomor PBT</label>
                <input disabled id="no_pbt" autocomplete=off type="text" class="mt-1 inline-block bg-gray-300 focus:border-green-500 focus:border-6 shadow-sm appearance-none border rounded w-full py-2 px-3 text-sm text-gray-700 leading-normal focus:outline-none mb-4"  name="no_pbt" value="<?=$d['no_pbt'];?>"/>
                ...
                <input  class="modal-open mt-1 rounded-md text-sm appearance-none border w-100 py-2 px-6 font-reguler bg-green-800 cursor-pointer hover:bg-gray-900 hover:transition duration-700 text-gray-400 leading-normal" type="submit" value="Update Data">
                ...
                <div class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
                  ...
                  <div class="modal-content py-4 text-left px-6">
                    ...
                    <div class="flex justify-end pt-2">
                      <input type="submit" class="px-4 bg-transparent p-3 rounded-lg text-indigo-500 hover:bg-gray-100 hover:text-indigo-400 mr-2" value="Update" name="update">
