...
$data = mysqli_query($connection, "SELECT * FROM target");
$judul = "TARGET";
            ...
            <table class="table-auto w-full">
              ...
              ?>
                <tr class="text-center">
                  <td class="border px-4 py-2"><?=$d['target'];?></td>
                  <td class="border px-4 py-2">
                    <a href="edit_target.php?id=<?=$d['id'];?>"><button title="Edit" class="bg-green-400 px-2 py-1 text-sm rounded-md text-green-700"> <i class="fa fa-edit fa-fw"></i> </button></a>
                  </td>
                </tr>
                <?php } ?>
              </tbody>
