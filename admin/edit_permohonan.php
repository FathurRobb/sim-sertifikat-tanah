          ...
          <div class="w-full md:w-1/2 xl:w-1/2 p-3">
            <div class="bg-white border rounded shadow p-10">
              ...
              <form action="" method="POST" class="bg-white rounded mt-4">
                ...
                <input disabled id="id_permohonan" autocomplete=off type="text" class="mt-1 inline-block bg-gray-300 focus:border-green-500 focus:border-6 shadow-sm appearance-none border rounded w-full py-2 px-3 text-sm text-gray-700 leading-normal focus:outline-none mb-4"  name="id_permohonan" value="<?=$d['id_permohonan'];?>"/>
                <label for="nama_lengkap" class="flex flex-wrap text-sm font-bold text-gray-500 leading-tight">Nama</label>
                <input disabled id="nama_lengkap" autocomplete=off type="text" class="mt-1 inline-block bg-gray-300 focus:border-green-500 focus:border-6 shadow-sm appearance-none border rounded w-full py-2 px-3 text-sm text-gray-700 leading-normal focus:outline-none mb-4"  name="nama_lengkap" value="<?=$row['nama_lengkap'];?>"/>
                <label for="kecamatan" class="flex flex-wrap text-sm font-bold text-gray-500 leading-tight">Kecamatan</label>
                <input disabled id="kecamatan" autocomplete=off type="text" class="mt-1 inline-block bg-gray-300 focus:border-green-500 focus:border-6 shadow-sm appearance-none border rounded w-full py-2 px-3 text-sm text-gray-700 leading-normal focus:outline-none mb-4"  name="kecamatan" value="<?=$d['kecamatan'];?>"/>
                <label for="desa" class="flex flex-wrap text-sm font-bold text-gray-500 leading-tight">Desa</label>
                <input disabled id="desa" autocomplete=off type="text" class="mt-1 inline-block bg-gray-300 focus:border-green-500 focus:border-6 shadow-sm appearance-none border rounded w-full py-2 px-3 text-sm text-gray-700 leading-normal focus:outline-none mb-4"  name="desa" value="<?=$d['desa'];?>"/>
                ...
                <select name="status" id="status" class="mt-1 inline-block bg-gray-300 focus:border-green-500 focus:border-6 shadow-sm appearance-none border rounded w-full py-2 px-3 text-sm text-gray-700 leading-normal focus:outline-none mb-4">
                    ...
                    <option value="Disetujui" <?php if($d['status']=="Disetujui") echo 'selected="selected"'; ?>>Disetujui</option>
                    <option value="Ditolak" <?php if($d['status']=="Ditolak") echo 'selected="selected"'; ?>>Ditolak</option>
                  </select><br>
                <input  class="modal-open mt-1 rounded-md text-sm appearance-none border w-100 py-2 px-6 font-reguler bg-red-800 cursor-pointer hover:bg-gray-900 hover:transition duration-700 text-gray-400 leading-normal" type="submit" value="Update Data">
