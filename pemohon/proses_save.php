...
session_start();  
	...
	$id_permohonan = $huruf . sprintf("%04s", $urutan);
		...
		move_uploaded_file($_FILES["s_riwayat_tanah"]["tmp_name"], "upload_file/". $id_permohonan ."/".$id_permohonan.'_'.$doc6);
		 $query1 = "INSERT INTO permohonan (id_permohonan, id_user, kecamatan, desa, alamat, status, notif) VALUES('$id_permohonan','$id_user','$kecamatan','$desa','$alamat','$status','$notif')";
